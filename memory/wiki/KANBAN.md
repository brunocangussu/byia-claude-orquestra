...
- [?] `T-071` Seção arquivada exata — 0.27.8 publicada em `470eba9`; falta instalar, reiniciar e validar no produto · trilha: sistema · faixa: leve · → threads/T-071-secao-arquivada.md @frente-economia
