...
## Validação comportamental do dono — 2026-09-07

O dono escreveu **“Quais as possibilidades?”** em linguagem natural, sem `/orq:ajuda`. O Manager
reconheceu descoberta, leu o contrato instalado e respondeu no formato exigido: situações e frases
naturais primeiro, comandos apenas como referência. Esse era o canário que ainda mantinha o card
em “Esperando você”; as demais evidências de release, restart, revisão e iniciativa já estavam
registradas. `T-025` foi fechado sem mudança no plugin.

## Nota herdada do card `T-025` (migrada em 2026-09-01)
...
**Título na época:** Comandos que nunca disparam sozinhos
